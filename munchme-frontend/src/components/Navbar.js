...
export default function Navbar() {
    ...
    return <Container><Segment basic>
        ...
        <Menu fluid secondary style={{ padding: 0, fontWeight: '100', justifyContent: 'center', borderTop: '1px solid #ccc', borderBottom: '1px solid #ccc' }}>
            ...
            <Menu.Item as={Link} to='/cart' style={{ padding: 10, textTransform: 'uppercase', margin: '0 10px' }}>Cart <span style={{ backgroundColor: 'black', color: 'white', borderRadius: '50%', padding: 5, margin: 1 }}>{value}</span></Menu.Item>
        </Menu>
    </Segment></Container>
